...
CallResult GfxSpriteBase<BaseRect>::init(GC x, GC y, GC x2, GC y2, GfxUsableImage *img)
{
...
template<class BaseRect>
void GfxSpriteBase<BaseRect>::setImg(GfxUsableImage *img)
{
	var_selfs(img);
...
template<class BaseRect>
void GfxSpriteBase<BaseRect>::setImg(GfxUsableImage *img, GTexC leftTexU, GTexC topTexV, GTexC rightTexU, GTexC bottomTexV)
{
	var_selfs(img);
...
void GfxSpriteBase<BaseRect>::draw(uint manageBlend) const
{
	...
	Gfx::setActiveTexture(img->textureDesc().tid);
