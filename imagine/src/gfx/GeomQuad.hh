...
public:
	...
	CallResult init(const GeomRectDesc *d)
	{
	...
	{
		GeomRectDesc d(a->xPos(LB2DO), a->yPos(LB2DO),
	...
	{
		using namespace Gfx;
		GeomRectDesc d(gXPos(b, LB2DO), gYPos(b, LB2DO),
				gXPos(b, RT2DO), gYPos(b, RT2DO));
		draw(&d);
	}

	static void draw(const GeomRectDesc *d)
	{
