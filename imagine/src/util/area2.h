...
public:
	...
	int xIPos(GC frac, _2DOrigin o) const { return xIOrigin(o) + ((GC)iXSize * frac); }
	...
	int yIPos(GC frac, _2DOrigin o) const { return yIOrigin(o) + ((GC)iYSize * frac); }
	int yIPos(_2DOrigin o) const { return yIOrigin(o); }

	int xIPosCustomInvI(int pos, int range, _2DOrigin o) const { return IG::scalePointRange((GC)(pos - xIOrigin(o)), (GC)0, (GC)iXSize, (GC)0, (GC)range); }
	int yIPosCustomInvI(int pos, int range, _2DOrigin o) const { return IG::scalePointRange((GC)(pos - yIOrigin(o)), (GC)0, (GC)iYSize, (GC)0, (GC)range); }
