...
static void default_pc_changed_callback(M68KCPU &m68ki_cpu, unsigned int new_pc)
{
...
void m68k_set_pc_changed_callback(M68KCPU &m68ki_cpu, void  (*callback)(M68KCPU &m68ki_cpu, unsigned int new_pc))
{
